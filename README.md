...
- `hooks`: _(optional)_ Run commands in separate bash shells with the environment variables configured for the application and environment variables for `PROJECT_ID`, `K_SERVICE`, and `REGION`. Command outputs are shown as they are executed.
